...
const Conditions = () => {
  return (
    <main className="  w-full flex h-screen flex-col min-w-[800px] justify-between items-center  brightness-95 ">
      <Header text={"قبلا ثبت نام کردی؟"} btntitle={"ورود"} />
      <div className=" flex justify-center items-end ">
        <Card style="w-40 h-40 mb-10 ml-20 bg-pink-primary px-2 text-center ">
          <NavLink to="/register">بازگشت به فرم ثبت‌نام</NavLink>
        </Card>

        <Card style={"w-[540px] h-[540px] mb-20 z-50"}>
          <h1 className="text-3xl pt-10 text-brand-primary">
            قوانین و مقررات
          </h1>
